...
{
	public static final String CATEGORY_EFBS_SKILLS = "key.category.battle_arts_api.skills";
	...
	public static final String SPECIAL_ART = key("special_art_use");
	...
	public static final KeyMapping USE_SPECIAL_ART = new KeyMapping(SPECIAL_ART, KeyConflictContext.IN_GAME,
