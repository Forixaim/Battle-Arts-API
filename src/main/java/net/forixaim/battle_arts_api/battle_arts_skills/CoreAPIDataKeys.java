...
{
    public static final DeferredRegister<SkillDataKey<?>> DATA_KEYS = DeferredRegister.create(EpicFightSkillDataKeys.REGISTRY.getRegistryKey(), BattleArtsAPI.MOD_ID);
