...
public class CoreAPIDataKeys
{
    ...
    public static final RegistryObject<SkillDataKey<Integer>> COMBAT_COOLDOWN = DATA_KEYS.register("combat_cooldown", () -> SkillDataKey.createSkillDataKey(PacketBufferCodec.INTEGER, 0, true, BattleStyle.class));
